...
As of May 14, 2026, after the Gate 5 hydration-runtime checkpoint:
...
- Production `src`: `14247` insertions, `12721` deletions, net `+1526`.
- Current production `src` TypeScript/TSX total: `35036` lines.
...
- Source-only baseline comparison from
  `7088db374448845ef6e71cf74817aa53efbc5fc1`: `14247` insertions, `12721`
  deletions, net `+1526`; current production `src` TypeScript/TSX total is
  `35036` lines.
...
- Expansion reducer/runtime effects: not complete; same-axis fetch-loop
  ...
  runtime hook. Same-axis in-flight bookkeeping now lives in its own hook, but
  `useExpansionEngine.ts` still owns reinitialization-triggered prefetch
  scheduling.
