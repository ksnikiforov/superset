...
- Production `src`: `13414` insertions, `17784` deletions, net `-4370`.
- Current production TypeScript/TSX total: about `29140` lines.
...
| --- | ---: | ---: | ---: | ---: |
| Full production `src` | `33510` | `29140` | `-4370` | `< 28000` |
