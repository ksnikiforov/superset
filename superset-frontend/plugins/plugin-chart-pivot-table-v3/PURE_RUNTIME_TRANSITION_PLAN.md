...
`0c27d67d2b refactor(pivot-table-v3): extract interaction layout shell`:
...
- Production `src`: `9867` insertions, `10474` deletions, net `-607`.
- Current production `src` TypeScript/TSX total: `32903` lines.
