...
`a6e314db62 refactor(pivot-table-v3): fold expansion fetch deltas into executor`:
...
- Production `src`: `12983` insertions, `12306` deletions, net `+677`.
- Current production `src` TypeScript/TSX total: `34187` lines.
...
- Source-only baseline comparison from
  `7088db374448845ef6e71cf74817aa53efbc5fc1`: `12983` insertions, `12306`
  deletions, net `+677`; current production `src` TypeScript/TSX total is
  `34187` lines.
