...
`f8585ff066 fix(pivot-table-v3): ignore stale expansion deltas after layout changes`:
...
- Production `src`: `12996` insertions, `12313` deletions, net `+683`.
...
- Source-only baseline comparison from
  `7088db374448845ef6e71cf74817aa53efbc5fc1`: `12996` insertions, `12313`
  deletions, net `+683`; current production `src` TypeScript/TSX total is
  `34193` lines.
