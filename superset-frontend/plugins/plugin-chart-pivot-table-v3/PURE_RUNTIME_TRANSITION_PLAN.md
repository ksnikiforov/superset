...
`73f92498ef refactor(pivot-table-v3): centralize databar runtime model`:
...
- Production `src`: `10583` insertions, `10865` deletions, net `-282`.
- Current production `src` TypeScript/TSX total: `33228` lines.
