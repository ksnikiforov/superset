...
- Full plugin: `111` files changed, `9815` insertions, `4446` deletions.
- Production `src`: `38` files changed, `4874` insertions, `3752`
  deletions.
- Tests: `72` files changed, `4363` insertions, `682` deletions.
