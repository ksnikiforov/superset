...
`19b7fe3a7a refactor(pivot-table-v3): centralize persisted expansion visibility`:
...
- Production `src`: `10173` insertions, `10576` deletions, net `-403`.
- Current production `src` TypeScript/TSX total: `33107` lines.
