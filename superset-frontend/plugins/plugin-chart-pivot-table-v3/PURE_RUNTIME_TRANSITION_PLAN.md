...
- Production `src`: `13112` insertions, `12349` deletions, net `+763`.
...
- Source-only baseline comparison from
  `7088db374448845ef6e71cf74817aa53efbc5fc1`: `13112` insertions, `12349`
  deletions, net `+763`; current production `src` TypeScript/TSX total is
  `34273` lines.
...
- Query planning from coverage: not complete; fetch-context support/totals
  ...
  unused compatibility outputs, but deeper bootstrap/root target selection and
