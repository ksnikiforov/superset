...
- Production `src`: `13122` insertions, `12356` deletions, net `+766`.
...
- Source-only baseline comparison from
  `7088db374448845ef6e71cf74817aa53efbc5fc1`: `13122` insertions, `12356`
  deletions, net `+766`; current production `src` TypeScript/TSX total is
  `34276` lines.
