...
- Production `src`: `13221` insertions, `12372` deletions, net `+849`.
...
- Source-only baseline comparison from
  `7088db374448845ef6e71cf74817aa53efbc5fc1`: `13221` insertions, `12372`
  deletions, net `+849`; current production `src` TypeScript/TSX total is
  `34359` lines.
...
- Chart component cleanup: not complete; runtime-layout state and prop sync now
  live outside `PivotTableChart.tsx`, but the chart still owns committed
  tree/fact state, runtime persistence side-effect execution, and
