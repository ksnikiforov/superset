...
`39354e0a7b refactor(pivot-table-v3): emit export row model`:
...
- Production `src`: `12050` insertions, `11619` deletions, net `+431`.
- Current production `src` TypeScript/TSX total: `33941` lines.
