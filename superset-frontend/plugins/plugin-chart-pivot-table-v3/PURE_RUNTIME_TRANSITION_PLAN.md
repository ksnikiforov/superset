...
`344d17dc17 refactor(pivot-table-v3): move persisted selection sync policy`:
...
- Production `src`: `8254` insertions, `9448` deletions, net `-1194`.
- Current production `src` TypeScript/TSX total: `32316` lines.
