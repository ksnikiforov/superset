...
- Production `src`: `13304` insertions, `18186` deletions, net `-4882`.
- Current production TypeScript/TSX total: about `28628` lines.
...
| --- | ---: | ---: | ---: | ---: |
| Full production `src` | `33510` | `28628` | `-4882` | `< 28000` |
| Strict core pipeline | `11337` | `11464` | `+127` | `8000` |
