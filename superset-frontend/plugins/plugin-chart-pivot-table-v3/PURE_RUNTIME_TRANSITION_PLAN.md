...
- Production `src`: `13104` insertions, `12316` deletions, net `+788`.
...
- Source-only baseline comparison from
  `7088db374448845ef6e71cf74817aa53efbc5fc1`: `13104` insertions, `12316`
  deletions, net `+788`; current production `src` TypeScript/TSX total is
  `34298` lines.
...
- Query planning from coverage: not complete; fetch-context support/totals
  coverage composition is centralized, but bootstrap/root target selection and
  compatibility coverage cases remain Gate 2 risk.
