...
- Production `src`: `13322` insertions, `18177` deletions, net `-4855`.
- Current production TypeScript/TSX total: about `28655` lines.
...
| --- | ---: | ---: | ---: | ---: |
| Full production `src` | `33510` | `28655` | `-4855` | `< 28000` |
| Strict core pipeline | `11337` | `11488` | `+151` | `8000` |
| Non-visual chart runtime hooks | `4683` | `4893` | `+210` | `3000-4000` |
| Broad core pipeline | `16020` | `16381` | `+361` | `11000-13000` |
