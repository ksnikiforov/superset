...
`78aabd4121 refactor(pivot-table-v3): centralize selection filtered form data`:
...
- Production `src`: `11834` insertions, `11323` deletions, net `+511`.
- Current production `src` TypeScript/TSX total: `34021` lines.
