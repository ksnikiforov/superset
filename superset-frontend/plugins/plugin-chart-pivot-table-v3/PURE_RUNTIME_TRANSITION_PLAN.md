...
`a0334d6977 refactor(pivot-table-v3): derive interaction layout from program`:
...
- Production `src`: `13000` insertions, `12305` deletions, net `+695`.
- Current production `src` TypeScript/TSX total: `34205` lines.
