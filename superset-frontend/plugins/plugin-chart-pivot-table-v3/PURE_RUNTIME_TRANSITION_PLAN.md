...
- Production `src`: `13106` insertions, `12333` deletions, net `+773`.
...
- Source-only baseline comparison from
  `7088db374448845ef6e71cf74817aa53efbc5fc1`: `13106` insertions, `12333`
  deletions, net `+773`; current production `src` TypeScript/TSX total is
  `34283` lines.
