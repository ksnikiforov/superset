...
`7fef669ad6 refactor(pivot-table-v3): derive layout groupbys from program`:
...
- Production `src`: `13008` insertions, `12265` deletions, net `+743`.
- Current production `src` TypeScript/TSX total: `34253` lines.
...
- Focused metric-control pass after cleaning hook dependency arrays: `1` suite
  and `15` tests.
- Focused metric-tier layout pass after deriving `usePivotLayout` groupbys from
  the compiled layout context: `1` suite and `8` tests.
